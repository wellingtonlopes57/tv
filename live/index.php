...
header("Cache-Control: max-age=4, public"); 

        $ch_id = "7";
        $backend_url = "https://live.esporteflix.com/";
        $referer = "https://esporteone.com/player/multicanais.php?canal=GLOBORJ";
      ...
      $url = $backend_url . substr($request_uri, 8);
